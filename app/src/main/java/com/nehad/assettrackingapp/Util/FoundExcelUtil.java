...
public class FoundExcelUtil {
    ...
    public static boolean exportDataIntoWorkbook(Context context, String fileName,
        ...
        sheet = workbook.createSheet("Found Assets ");
    ...
    private static void fillDataIntoExcel (Context context , List<AssetModel> dataList) {
        ...
        new Thread(() -> {
            ...
            assetModelList = AssetsDatabase.getAssetsDatabase(context.getApplicationContext()).assetsDao().getAllFoundAsset(true);
